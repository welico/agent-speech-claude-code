...
variables:
  - feature: agent-speech-claude-code
  - date: 2026-02-12
  - author: welico
...
|-------|----------|--------|
| Plan | [agent-speech-claude-code.plan.md](../../01-plan/features/agent-speech-claude-code.plan.md) | ✅ Finalized |
| Design | [agent-speech-claude-code.design.md](../../02-design/features/agent-speech-claude-code.design.md) | ✅ Finalized |
| Check | [agent-speech-claude-code.analysis.md](../../03-analysis/features/agent-speech-claude-code.analysis.md) | ✅ Complete |
